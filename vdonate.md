...
16. Возможно ввести почту со спецсимволами в домене ✅
    > **[Баг]**
...
17. Самбит пустого поля с email не изменяет email ✅
18. Подсказка при наведении на инпут отображается ✅
    > **[БАГ]**
...
19. pop-up при отправке невалидных данных показывается ✅
17. Красная рамка вокруг инпута при отправке невалидных данных отображается ✅
