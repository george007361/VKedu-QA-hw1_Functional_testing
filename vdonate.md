...
1. Нажатие на кнопку *лайка* серого цвета **мгновенно** увеличивает суммарное число на единицу; ❌
    ...
    >
    > `Ожидание:` Содержимое компонента должно мгновенно инкрементироваться, а цвет меняться на фиолетовый.
    >
...
1. При нажатии на кнопку *комментарий* под постом вылезают все комментарии; ❌
    ...
    >
    > `Фактический результат:` Появление комментариев не должно сопровождаться фиктивным лоаддером.
    >
