...
6. Возможно установить email длиной до 255 символов ❌
   ...
   > 
   > Ожидаемый результат: Возможность установить email длиной до 255 символов
   > 
   > Фактический результат: Невозможность установить почту длиннее 64 символов
...
14. pop-up при отправке невалидных данных показывается ✅
15. Красная рамка вокруг инпута при отправке невалидных данных отображается ✅
